...
BUILTIN_DATA_SETS = {
    'ml-100k':
        BuiltinData_set(
            ...
            path='D:/Programming_tools/Pycharm/code/WCSP-zhaoyu/ml-100k/u.data',
            sep='\t',
    ...
    'ml-1m':
        BuiltinData_set(
            ...
            path='D:/Programming_tools/Pycharm/code/WCSP-zhaoyu/ml-1m/ratings.dat',
            sep='::',
            reader_params=dict(line_format='user item rating timestamp',
                               rating_scale=(1, 5),
                               sep='::')
...
def normalized_data(data_set):
    normalized_data = (data_set - data_set.min()) / (data_set.max() - data_set.min())
